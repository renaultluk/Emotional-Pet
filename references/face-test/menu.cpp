...
void Rounded::draw()
{
  ...
  {
    if (primary)
      // tft.fillRoundRect(x, y, w, h, CORNER_RADIUS, PRIMARY_COLOR);
      cout << "Primary Rounded " << name << " drawn" << endl;
    else
...
void Text::draw()
{
  if (primary) 
    ...
    cout << "Primary Text " << content << " drawn" << endl;
  else 
    // tft.setTextColor(SECONDARY_COLOR);
    cout << "Secondary Text " << content << " drawn" << endl;
